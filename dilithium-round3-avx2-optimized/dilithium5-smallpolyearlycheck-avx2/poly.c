...
void poly_ntt_tailored_reduction(poly *a) {
  DBENCH_START();

  ntt_avx_tailored_reduction(a->coeffs, qdata);

  DBENCH_STOP(*tmul);
}
void poly_ntt_lazy_reduction(poly *a) {
  DBENCH_START();

  ntt_avx_lazy_reduction(a->coeffs, qdata);
