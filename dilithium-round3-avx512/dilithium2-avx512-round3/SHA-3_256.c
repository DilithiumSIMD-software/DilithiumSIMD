...
// void shake256_avx512(const uint8_t *in, int inlen, uint8_t *out, int outlen)
// {
// 	__m512i x[5];
// 	int blocksize = 136;
...
//   uint8_t * in_temp = (uint8_t*)in;
//   uint8_t *t;
//   ALIGN uint8_t temp[136];
//   memset(temp, 0, 136*sizeof(uint8_t));
//   __m512i x[5];
//   x[0] = _mm512_setzero_si512();
//   x[1] = _mm512_setzero_si512();
//   x[2] = _mm512_setzero_si512();
...
// 	memset(temp + inlen, 0, 136 - inlen);
// 	temp[136 - 1] |= 0x80;
// 	t = temp;
//     load(t, 136);
// 	//squeezing process
// 	int nblocks = outlen/136;
// 	int remlen = outlen-nblocks*136;
// 	// printf("count:%d\n",count);
// 	printf("remlen:%d\n",remlen);
// 	uint8_t rembuf[136];
// 	for(j = 0; j < nblocks; j ++)
...
// 		 {
// 			keccakF(x, 24);
// 		 	_mm512_mask_storeu_epi64((__m512*)md,0x1F,x[i]);
// 			md += 40;
// 		 }
// 		keccakF(x, 24);
// 		_mm512_mask_storeu_epi64((__m512*)md,0x3,x[3]);
// 		md += 16;
// 	}
// 	int pos = 0;
// 	for(i = 0; i < 3; i ++)
// 	{
// 		keccakF(x, 24);
// 		_mm512_mask_storeu_epi64((__m512*)&rembuf[pos],0x1F,x[i]);
// 		pos += 40;
// 	}
// 	keccakF(x, 24);
// 	_mm512_mask_storeu_epi64((__m512*)rembuf[pos],0x3,x[3]);
// 	pos += 16;
// 	for(i = 0; i < remlen; i ++)
// 	{
// 		md[i] = rembuf[i]; 
...
// 		 keccakF(x, 24);
// 		 uint8_t rembuf[136];
// 		 _mm512_mask_storeu_epi64((__m512*)rembuf,0x1F,x[count]);
// 		 for(i = 0; i < remlen; i ++)
// 		 {
// 			md[i] = rembuf[i]; 
// 		 }
...
// 		 {
// 			keccakF(x, 24);
// 		 	_mm512_mask_storeu_epi64((__m512*)md,0x1F,x[i-5]);
// 			md += 40;
// 		 }
// 		 keccakF(x, 24);
// 		 uint8_t rembuf[136];
// 		 _mm512_mask_storeu_epi64((__m512*)rembuf,0x1F,x[count-5]);
// 		 for(i = 0; i < remlen; i ++)
// 		 {
// 			md[i] = rembuf[i]; 
// 		 }
