                          ...
                          const uint8_t *sk)
{
  ...
  poly cp;
  poly tmp;
  __attribute__((aligned(64))) uint32_t s11_table[2*N]={0};
  __attribute__((aligned(64))) uint32_t s12_table[2*N]={0};
  __attribute__((aligned(64))) uint32_t s21_table[2*N]={0};
  __attribute__((aligned(64))) uint32_t s22_table[2*N]={0};
